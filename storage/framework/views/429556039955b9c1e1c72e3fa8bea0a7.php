...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('layouts.partials.page-title', ['title' => 'POS', 'subtitle' => 'Point of Sale'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    `).join('');
           ...
           <input id="swalCusPhone" class="swal2-input" placeholder="Phone (optional)">`,
            ...
            async function fetchProductByBarcode(barcode) {
                const url = `<?php echo e(route('pos.productByBarcode')); ?>?barcode=${encodeURIComponent(barcode)}`;
                const res = await fetch(url, {
                    headers: {
                        'Accept': 'application/json'
                    }
    ...
    `).join('');
            ...
            async function searchProducts(q) {
                const url = `<?php echo e(route('pos.searchProducts')); ?>?q=${encodeURIComponent(q)}`;
                const res = await fetch(url, {
                    headers: {
                        'Accept': 'application/json'
                    }
            ...
            completeBtn.addEventListener('click', async function() {
                ...
                try {
                    ...
                    const res = await fetch(`<?php echo e(route('pos.storeSale')); ?>`, {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
                            "Accept": "application/json",
...
<?php echo $__env->make('layouts.vertical', ['subtitle' => 'POS'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Personal Projects\Upswep\upswep\resources\views/pos/index.blade.php ENDPATH**/ ?>