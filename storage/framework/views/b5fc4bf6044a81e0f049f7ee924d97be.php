...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('layouts.partials.page-title', ['title' => 'Stock Entry', 'subtitle' => 'Create'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            ...
            <a href="<?php echo e(route('admin.stock-entries.index')); ?>" class="btn btn-light btn-sm">Back</a>
        </div>

        <div class="card-body">
            <div id="message"></div>

            <form id="stockEntryForm" action="<?php echo e(route('admin.stock-entries.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" class="form-control" name="entry_date" value="<?php echo e(date('Y-m-d')); ?>"
                            required>
                    </div>
...
<?php echo $__env->make('layouts.vertical', ['subtitle' => 'Stock Entry Create'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Personal Projects\Upswep\upswep\resources\views/admin/stock_entries/create.blade.php ENDPATH**/ ?>