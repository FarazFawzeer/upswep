...
<?php echo $__env->make('layouts.partials.page-title', ['title' => 'Supplier', 'subtitle' => 'Create'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form id="createSupplierForm" action="<?php echo e(route('admin.suppliers.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.vertical', ['subtitle' => 'Supplier Create'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Personal Projects\Upswep\upswep\resources\views/admin/suppliers/create.blade.php ENDPATH**/ ?>