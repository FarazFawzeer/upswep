...
<?php echo $__env->make('layouts.partials.page-title', ['title' => 'Reports', 'subtitle' => 'Sales by Cashier'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <form class="d-flex gap-2" method="GET" action="<?php echo e(route('admin.reports.sales.byCashier')); ?>">
            ...
            <a class="btn btn-light btn-sm" href="<?php echo e(route('admin.reports.sales.byCashier')); ?>">Reset</a>
        </form>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover table-centered">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td class="fw-semibold"><?php echo e($cashiers[$r->cashier_id] ?? '—'); ?></td>
...
<?php echo $__env->make('layouts.vertical', ['subtitle' => 'Sales by Cashier'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\Personal Projects\Upswep\upswep\resources\views/admin/reports/sales_by_cashier.blade.php ENDPATH**/ ?>